...
public class FrontEndApptSystem {
	...
	public static void importAppointments(AppointmentSystem appSystem) {
		try {
			Scanner scan = new Scanner(new FileInputStream("OpenAppointments.txt"));	
			BufferedReader br = new BufferedReader(new FileReader("OpenAppointments.txt"));
	...
	public static void getCommonValues(String[] common) {
		...
		String[] types = {"Maintenance", "Inspection"};
